...
import { NAJHookContracts } from "@/utils/addresses"
import { NAJHookLaunchPadAbi } from "@/utils/abi/NAJHookLaunchPad"
...
export default function DeployPage() {
  ...
  const approveTokens = async () => {
    ...
    const launchpadAddress = NAJHookContracts[uniChainSepolia.id]
    if (!launchpadAddress) {
      ...
      <div className="container mx-auto px-6 pt-32 pb-20" style={{ maxWidth: currentStep === 3 || currentStep === 4 ? '100%' : '72rem' }}>
        <div className="mx-auto" style={{ maxWidth: currentStep === 3 || currentStep === 4 ? '100%' : '48rem' }}>
          ...
          <div className="mb-12 text-center">
            <h1 className="mb-4 text-4xl font-bold tracking-tight">Deploy New NAJ AMM</h1>
