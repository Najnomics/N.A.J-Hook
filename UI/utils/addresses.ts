export const NAJHookContracts = {
  1301: '0x2C9Be74729176439D8Bf99EFaE048ccB62a9FDEd',
} as {
  [key: number]: `0x${string}`
}

// NajHook address for swap routing
export const NAJ_HOOK_ADDRESS = (process.env.NEXT_PUBLIC_NAJ_HOOK_ADDRESS || '0x6a97647586C26013C048b7EE63c47D96Fd47Ca88') as `0x${string}`
