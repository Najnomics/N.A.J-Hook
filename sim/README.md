# NajLaunchpad Sequencer Parameter TUI Simulator

A beautiful terminal user interface (TUI) for managing and simulating NajLaunchpad sequencer parameters with **real-time price data from Pyth Network**.
...
- [NajLaunchpad Contracts](../contracts) - Smart contracts for the launchpad
- [NajLaunchpad Sequencer](../sequencer) - The actual sequencer service
- [NajLaunchpad UI](../UI) - Web interface for users
