...
export const batcherAbi = [
  {
    ...
    inputs: [
      ...
      { name: "_najLaunchpad", type: "address", internalType: "address" },
      { name: "_najHook", type: "address", internalType: "address" },
      { name: "_poolManager", type: "address", internalType: "address" },
      { name: "_universalRouter", type: "address", internalType: "address" },
      { name: "_najRouter", type: "address", internalType: "address" },
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: "", type: "address", internalType: "contract INajHook" },
    ],
    stateMutability: "view",
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: "", type: "address", internalType: "contract INajLaunchpad" },
    ],
    stateMutability: "view",
  },
  {
